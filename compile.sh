...
g++ -o player player.o mediaplayer.o fourcc.o clock.o audio.o video.o demux.o -lSDL -lao -lavutil -lavformat -lavcodec -lavdevice -lswresample -lswscale -pthread #-lva -lva-x11 -I/usr/include/va  
