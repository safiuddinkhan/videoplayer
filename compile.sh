...
g++ -c player2.cpp -o player2.o
g++ -o player2 player2.o mediaplayer.o fourcc.o clock.o audio.o video.o demux.o -lao -lavutil -lavformat -lavcodec -lavdevice -lswresample -lswscale -pthread `pkg-config --cflags --libs taglib` -lX11 -lXext -lXv -lva -lva-x11 -I/usr/include/va  
